    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" id="eaddress" class="form-control form-control-lg" value="{{Auth::user()->email}}" disabled>
                </div>
                <div class="col-md-6 form-group">
                    <label for="tel">Tel. Number</label>
                    <input type="text" id="tel" class="form-control form-control-lg" value="{{Auth::user()->phone}}" disabled>
                </div>
            </div>
            <div class="row">
